    ...
    def _scrape_year(self, year: int):
        ...
        for norm_type, norm_type_id in tqdm(
            ...
            if response.status_code != 200:
                print(
                    f"Error fetching data for Year: {year} | Type: {norm_type} | Status Code: {response.status_code}"
                )
                continue
